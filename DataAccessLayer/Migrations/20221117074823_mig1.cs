            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Feature2ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Posts1Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Posts1Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Posts1Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
